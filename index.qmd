...
Dans le syntaxe ci-dessous nous allons compter le nombre de ménage concerné par les doublons sur les 14253
...
-   Pour un même jour un enquêteur renseigne que seul un membre du ménage est présent et le précise dans les observations ets un autre enquêteur enquête le ménage et renseigne avoir identifié tous les membres de ce ménages.
-   Pour même ménage une partie des membres ont été identifié le premier jour de la collecte, les membres absents sont quant à eux enregistrés le dernier jour de l'enquête.
